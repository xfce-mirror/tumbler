...
tumbler_plugin_initialize (TumblerProviderPlugin *plugin)
{
  ...
  g_debug ("Initializing the Tumbler Gepub Thumbnailer plugin");
  ...
  type_list[0] = GEPUB_TYPE_THUMBNAILER_PROVIDER;
}
...
{
  g_debug ("Shutting down the Tumbler Gepub Thumbnailer plugin");
}
