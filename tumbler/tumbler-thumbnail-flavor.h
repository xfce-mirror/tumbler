...
TumblerThumbnailFlavor *tumbler_thumbnail_flavor_new_xxx_large  (void) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
TumblerThumbnailFlavor *tumbler_thumbnail_flavor_new_xxxx_large (void) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
