...
#define TUMBLER_CACHE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), TUMBLER_TYPE_CACHE, TumblerCacheClass))
#define TUMBLER_IS_CACHE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), TUMBLER_TYPE_CACHE))
#define TUMBLER_IS_CACHE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), TUMBLER_TYPE_CACHE)
#define TUMBLER_CACHE_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), TUMBLER_TYPE_CACHE, TumblerCacheClass))

typedef struct _TumblerCachePrivate TumblerCachePrivate;
typedef struct _TumblerCacheClass   TumblerCacheClass;
typedef struct _TumblerCache        TumblerCache;

GType         tumbler_cache_get_type (void) G_GNUC_CONST;

TumblerCache *tumbler_cache_new      (DBusGConnection       *connection) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
gboolean      tumbler_cache_start    (TumblerCache          *cache,
                                      GError               **error);
